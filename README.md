...
While I've been fortunate to have wonderful industry jobs in the past, open-source software has a special place in my heart. It is liberating to code without worrying about profits or temptations to monetize users and profit off their data. While I make much less in open-source software, I am fortunate to make it my full-time career.

Your support through [sponsorships](https://github.com/sponsors/braden-w) is greatly appreciated, but please only contribute if you feel financially secure enough to do so. Your contributions enable me to pursue and develop projects like [Epicenter](https://github.com/EpicenterHQ/epicenter), [Wellcrafted](https://github.com/wellcrafted-dev/wellcrafted), and other projects that I hope to help the community. Thank you for your time!
